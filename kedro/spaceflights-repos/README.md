...
This is your new Kedro project, which was generated using `Kedro 0.17.1`, with the completed version of the [Space Flights tutorial](https://kedro.readthedocs.io/en/stable/03_tutorial/01_spaceflights_tutorial.html) and the data necessary to run the project.
